    ...
    statements = [
      ...
      *entity_member_of_statements,
      ...
      RDF::Statement(
        ...
        # Define hasParent value as the entry point for the versioned AIP API, in this case the path is '/aip/v1'
        object: self_subject.join(self_subject.path.split('/')[0, 3].join('/'))
      )
    ]
